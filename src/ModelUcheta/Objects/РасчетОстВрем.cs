...
namespace IIS.ModelUcheta
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ModelUcheta.DetailArrayOfОказУслуг fОказУсл;
        ...
        public virtual IIS.ModelUcheta.DetailArrayOfОказУслуг ОказУсл
        {
            get
            {
                ...
                {
                    this.fОказУсл = new IIS.ModelUcheta.DetailArrayOfОказУслуг(this);
                }
                IIS.ModelUcheta.DetailArrayOfОказУслуг result = this.fОказУсл;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.ModelUcheta.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.ModelUcheta.РасчетОстВрем));
                }
            }
        }
    }
