...
namespace IIS.ModelUcheta
{
    ...
    public class ОказУслуг : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ModelUcheta.Договор fДоговор;
        
        private IIS.ModelUcheta.Услуги fУслуги;
        
        private IIS.ModelUcheta.РасчетОстВрем fРасчетОстВрем;
        ...
        [PropertyStorage(new string[] {
                "Договор"})]
        [NotNull()]
        public virtual IIS.ModelUcheta.Договор Договор
        {
            get
            {
                ...
                IIS.ModelUcheta.Договор result = this.fДоговор;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.ModelUcheta.Услуги Услуги
        {
            get
            {
                ...
                IIS.ModelUcheta.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.ModelUcheta.РасчетОстВрем.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "РасчетОстВрем"})]
        public virtual IIS.ModelUcheta.РасчетОстВрем РасчетОстВрем
        {
            get
            {
                ...
                IIS.ModelUcheta.РасчетОстВрем result = this.fРасчетОстВрем;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОказУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОказУслугE", typeof(IIS.ModelUcheta.ОказУслуг));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОказУслуг : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.ModelUcheta.DetailArrayOfОказУслуг members)

        // *** End programmer edit section *** (IIS.ModelUcheta.DetailArrayOfОказУслуг members)
        ...
        /// </summary>
        public DetailArrayOfОказУслуг(IIS.ModelUcheta.РасчетОстВрем fРасчетОстВрем) : 
                base(typeof(ОказУслуг), ((ICSSoft.STORMNET.DataObject)(fРасчетОстВрем)))
        {
        }
        
        public IIS.ModelUcheta.ОказУслуг this[int index]
        {
            get
            {
                return ((IIS.ModelUcheta.ОказУслуг)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.ModelUcheta.ОказУслуг dataobject)
        {
