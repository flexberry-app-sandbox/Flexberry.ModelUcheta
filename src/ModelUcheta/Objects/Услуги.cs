...
namespace IIS.ModelUcheta
{
    ...
    public class Услуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ModelUcheta.Услуга fНаименование;
        
        private IIS.ModelUcheta.ЗатрВремя fЗатрВремя;
        ...
        public virtual IIS.ModelUcheta.Услуга Наименование
        {
            get
            {
                ...
                IIS.ModelUcheta.Услуга result = this.fНаименование;
        ...
        [PropertyStorage(new string[] {
                "ЗатрВремя"})]
        [NotNull()]
        public virtual IIS.ModelUcheta.ЗатрВремя ЗатрВремя
        {
            get
            {
                ...
                IIS.ModelUcheta.ЗатрВремя result = this.fЗатрВремя;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугE", typeof(IIS.ModelUcheta.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугL", typeof(IIS.ModelUcheta.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиE", typeof(IIS.ModelUcheta.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиL", typeof(IIS.ModelUcheta.Услуги));
                }
            }
        }
    }
