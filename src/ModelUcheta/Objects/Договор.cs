...
namespace IIS.ModelUcheta
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ModelUcheta.Статус fСтатус;
        
        private IIS.ModelUcheta.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.ModelUcheta.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        
        private IIS.ModelUcheta.Длительность fДлительность;
        
        private IIS.ModelUcheta.Клиент fКлиент;
        ...
        public virtual IIS.ModelUcheta.Статус Статус
        {
            get
            {
                ...
                IIS.ModelUcheta.Статус result = this.fСтатус;
        ...
        public virtual IIS.ModelUcheta.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.ModelUcheta.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.ModelUcheta.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.ModelUcheta.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.ModelUcheta.Длительность Длительность
        {
            get
            {
                ...
                IIS.ModelUcheta.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.ModelUcheta.Клиент Клиент
        {
            get
            {
                ...
                IIS.ModelUcheta.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.ModelUcheta.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.ModelUcheta.Договор));
                }
            }
        }
    }
