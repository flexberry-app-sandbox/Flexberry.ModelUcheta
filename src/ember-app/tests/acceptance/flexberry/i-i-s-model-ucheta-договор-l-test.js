...
moduleForAcceptance('[AGAT] Acceptance | i i s model ucheta договор l');

test('testing i-i-s-model-ucheta-договор-l', function(assert) {
  visit('/i-i-s-model-ucheta-договор-l');
