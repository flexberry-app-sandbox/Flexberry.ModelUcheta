...
moduleForAcceptance('[AGAT] Acceptance | i i s model ucheta дир отд по раб с кл l');

test('testing i-i-s-model-ucheta-дир-отд-по-раб-с-кл-l', function(assert) {
  visit('/i-i-s-model-ucheta-дир-отд-по-раб-с-кл-l');
