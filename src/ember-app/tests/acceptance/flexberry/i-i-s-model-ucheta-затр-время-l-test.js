...
moduleForAcceptance('[AGAT] Acceptance | i i s model ucheta затр время l');

test('testing i-i-s-model-ucheta-затр-время-l', function(assert) {
  visit('/i-i-s-model-ucheta-затр-время-l');
