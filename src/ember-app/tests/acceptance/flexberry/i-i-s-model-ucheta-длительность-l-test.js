...
moduleForAcceptance('[AGAT] Acceptance | i i s model ucheta длительность l');

test('testing i-i-s-model-ucheta-длительность-l', function(assert) {
  visit('/i-i-s-model-ucheta-длительность-l');
