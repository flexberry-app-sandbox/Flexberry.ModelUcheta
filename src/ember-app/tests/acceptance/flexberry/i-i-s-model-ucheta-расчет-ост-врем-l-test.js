...
moduleForAcceptance('[AGAT] Acceptance | i i s model ucheta расчет ост врем l');

test('testing i-i-s-model-ucheta-расчет-ост-врем-l', function(assert) {
  visit('/i-i-s-model-ucheta-расчет-ост-врем-l');
