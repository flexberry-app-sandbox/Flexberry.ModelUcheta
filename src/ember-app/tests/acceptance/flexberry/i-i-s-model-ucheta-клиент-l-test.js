...
moduleForAcceptance('[AGAT] Acceptance | i i s model ucheta клиент l');

test('testing i-i-s-model-ucheta-клиент-l', function(assert) {
  visit('/i-i-s-model-ucheta-клиент-l');
