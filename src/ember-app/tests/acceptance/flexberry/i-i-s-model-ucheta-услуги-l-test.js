...
moduleForAcceptance('[AGAT] Acceptance | i i s model ucheta услуги l');

test('testing i-i-s-model-ucheta-услуги-l', function(assert) {
  visit('/i-i-s-model-ucheta-услуги-l');
